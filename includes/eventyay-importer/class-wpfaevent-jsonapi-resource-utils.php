<?php
/**
 * Eventyay JSON:API resource utility helpers.
 *
 * @package    Wpfaevent
...
/**
 * Low-level JSON:API resource helpers used by the importer parser.
 */
class Wpfaevent_JSONAPI_Resource_Utils {
	...
	public function eventyay_text_value( $value ) {
		return sanitize_text_field( $this->eventyay_scalar_value( $value ) );
	}
