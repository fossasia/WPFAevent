...
class EventCardDescriptionIntegrationTest extends WP_UnitTestCase {
	...
	/**
	 * Event card search data uses the displayed lead while edit data uses the raw excerpt.
	 */
	public function test_event_card_separates_search_text_from_edit_description() {
