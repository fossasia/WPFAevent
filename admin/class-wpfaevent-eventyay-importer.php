...
class Wpfaevent_Eventyay_Importer {
	 ...
	 * @return bool
	 */
	protected function eventyay_speaker_is_featured( $speaker_resource, $category = '' ) {
	 ...
	 * @return int
	 */
	protected function eventyay_speaker_featured_order( $speaker_resource ) {
	 ...
	 * @return array|string
	 */
	protected function decode_eventyay_error_body( $body ) {
		$decoded = json_decode( $body, true );
	 ...
	 * @return void
	 */
	protected function merge_eventyay_speaker( &$speakers, $speaker, $session ) {
	 ...
	 * @return array
	 */
	protected function merge_dashboard_speaker_state( $imported, $existing ) {
	 ...
	 * @return array
	 */
	protected function get_dashboard_speaker_state_keys( $speaker ) {
		$keys = array();
	 ...
	 * @return bool
	 */
	protected function is_eventyay_dashboard_speaker( $speaker ) {
	 ...
	 * @return array
	 */
	protected function sync_eventyay_speaker_posts( $speakers, $event_id ) {
		$result         = array(
			'created'      => 0,
			'updated'      => 0,
			'ids'          => array(),
	 ...
	 * @return bool
	 */
	protected function is_eventyay_speaker_post( $speaker_id ) {
	 ...
	 * @return array<int>
	 */
	protected function get_eventyay_event_speaker_ids( $event_id ) {
	 ...
	 * @return array<int>
	 */
	protected function get_eventyay_event_featured_speaker_ids( $event_id ) {
	 ...
	 * @return array<int>
	 */
	protected function get_eventyay_speaker_event_ids( $speaker_id ) {
	 ...
	 * @return array<int>
	 */
	protected function sanitize_eventyay_post_id_list( $post_ids ) {
	 ...
	 * @return void
	 */
	protected function sync_eventyay_event_speaker_relationships( $event_id, $previous_speakers, $current_speakers ) {
		$event_id          = absint( $event_id );
	 ...
	 * @return void
	 */
	protected function add_eventyay_event_to_speaker( $speaker_id, $event_id ) {
		$speaker_id = absint( $speaker_id );
		$event_id   = absint( $event_id );
	 ...
	 * @return void
	 */
	protected function remove_eventyay_event_from_speaker( $speaker_id, $event_id ) {
		$speaker_id = absint( $speaker_id );
		$event_id   = absint( $event_id );
	 ...
	 * @return array|WP_Error
	 */
	protected function upsert_eventyay_speaker_post( $speaker, $post_status = 'draft' ) {
	 ...
	 * @return int
	 */
	protected function find_eventyay_speaker_post( $eventyay_speaker_id ) {
	 ...
	 * @return void
	 */
	protected function update_or_delete_post_meta( $post_id, $key, $value ) {
	 ...
	 * @return bool
	 */
	protected function is_jsonapi_resource( $maybe_resource ) {
	 ...
	 * @return string
	 */
	protected function format_eventyay_date( $value, $timezone = null ) {
		$value = trim( (string) $value );
	 ...
	 * @return string
	 */
	protected function format_eventyay_time( $value, $timezone = null ) {
		$value = trim( (string) $value );
	 ...
	 * @return bool
	 */
	protected function eventyay_datetime_has_time( $value ) {
	 ...
	 */
	protected function eventyay_timezone_object( $timezone ) {
	 ...
	 * @return string
	 */
	protected function normalize_eventyay_datetime( $value ) {
		$value = trim( (string) $value );
	 ...
	 * @return mixed
	 */
	protected function read_dashboard_json_file( $filename, $fallback ) {
	 ...
	 */
	protected function write_dashboard_json_file( $filename, $data ) {
		$path = $this->get_dashboard_json_path( $filename );
		if ( is_wp_error( $path ) ) {
			return $path;
		}
	 ...
	 * @return string|WP_Error
	 */
	protected function get_dashboard_json_path( $filename ) {
	 ...
	 * @return string
	 */
	protected function truncate_string( $value ) {
