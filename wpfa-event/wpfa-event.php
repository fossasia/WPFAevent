...
class FOSSASIA_Landing_Plugin {
    ...
    public function load_template( $template ) {
        ...
        // The new CPT-based loader is now in class-fossasia-landing-loader.php and runs on the 'template_include' hook.
        // This function now only handles the fallback for the original JSON-based templates.
...
if ( defined( 'WP_CLI' ) && WP_CLI ) {
	require_once plugin_dir_path( __FILE__ ) . 'public/includes/class-wpfa-cli.php';
