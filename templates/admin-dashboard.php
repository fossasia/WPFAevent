...
<div class="container">
    ...
    <section class="dashboard-section" id="main-dashboard-content">
        <div class="dashboard-tabs">
            ...
            <div class="dashboard-tab <?php echo !$event_id ? 'active' : ''; ?>" data-panel="sections">Custom Sections</div>
        ...
        <form id="sectionForm">
            ...
            <fieldset>
                ...
                <div id="content-column-fields">
                    ...
                    <?php wp_editor( '', 'sectionContentBody', [
    ...
    (() => {
        ...
        const handleSettingsSubmit = async (e) => {
            ...
            const processSettings = async (newImageUrl) => {
                // Prepare all settings from the form to be saved for this event.
                ...
                // Use the directSave function to send only these settings for the current event.
                const result = await directSave('settings', settingsToSave, 'fossasia_manage_site_settings');

                if (result.success) {
                    // Update the local store to reflect the changes immediately in the UI.
                    store.settings = { ...store.settings, ...settingsToSave };
