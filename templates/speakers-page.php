...
<div id="page" class="site">
    <header class="nav" role="banner">
      <div class="container nav-inner">
        ...
        ?>
        <?php
            // Logo priority: Event-specific -> Global -> Default
          ...
          <?php
            ...
            if (!empty($navigation_data) && is_array($navigation_data)) {
                foreach ($navigation_data as $nav_item) {
                    ...
                    if ($item_type === 'link') {
                        $href = esc_url($nav_item['href']); // Use the raw href from navigation data
                        // If it's a hash link, prepend the current event's permalink
                        if (strpos($href, '#') === 0) {
